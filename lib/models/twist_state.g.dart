...
_$TwistStateImpl _$TwistStateFromJson(Map<String, dynamic> json) =>
    _$TwistStateImpl(
      seeds:
          (json['seeds'] as List<dynamic>).map((e) => e as String).toList(),
      twistCount: (json['twistCount'] as num).toInt(),
      scenesSinceLastTwist: (json['scenesSinceLastTwist'] as num).toInt(),
    );

Map<String, dynamic> _$TwistStateToJson(_$TwistStateImpl instance) =>
    <String, dynamic>{
